...
public class CategoryDetailsPopUp {
    ...
    public void setData(HistoricoController historicoController, Expense expense, boolean isEdit) {
    ...
    public void onDone() {
        ...
        if (tfMontante.getText().isEmpty() || textArea.getText().isEmpty() || dataPicker.getValue() == null) {
            ...
            historicoController.editExpense(expense, Float.parseFloat(tfMontante.getText()),dataPicker.getValue(),textArea.getText());
            activateElements(false);
            lblError.setVisible(false);
        }
    }
    ...
    public void onDelete(){
        historicoController.delete(expense);
        Stage stage = (Stage) root.getScene().getWindow();
        stage.close();
        historicoController.acaoAoFecharJanelaSecundaria();
    }
